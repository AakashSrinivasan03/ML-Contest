...
model=SVC(C=100, kernel='rbf', degree=3, gamma=0.0058, coef0=0.0, shrinking=True, probability=False, tol=0.001, cache_size=200, class_weight=None, verbose=True, max_iter=-1, decision_function_shape='ovr', random_state=None)
...
sub.to_csv("sub_9_2_2.csv", index=False) 
